  ...
  return (
    <Layout location={props.location} title={siteTitle}>
      ...
      <p>
        ...
        <strong>Autoscout24</strong>. I love crafting clean code, building great
        teams, coaching other folks and building data driven products. My tech
        toolbox includes Scala, Typescript, Node, React and AWS.
      </p>
      <p>
        ...
        <strong>Telefonica Germany</strong> moving data around and analyzing the
        data warehouse, I started my first full time job at{" "}
        <strong>Jambit</strong>, a munich based software consultancy. Working on
        many different projects with good people helped my learn quite a lot in
      ...
      <p>
        ...
        Currently I'm driving functional programming adoption with the typelevel
        ecosystem, building ai driven data products and coaching other
        developers.
      </p>
    </Layout>
  )
